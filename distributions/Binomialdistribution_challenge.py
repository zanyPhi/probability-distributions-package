...
class Binomial(Distribution):
    ...
    # Because the Binomial distribution class inherits from the Generaldistribution class,
    ...
    # TODO: use the __repr__ magic method to output the characteristics of the binomial distribution object.
